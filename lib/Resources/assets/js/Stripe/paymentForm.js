...
//const stripe = await loadStripe( $( '#credit_card_form_captureUrl' ).attr( 'data-capturekey' ) );
...
$( function () {
    ...
    $( '#credit_card_form' ).on( 'submit', function( e ) {
        ...
        var $form = $( '<form id="payment-form" action="' + $( '#credit_card_form_captureUrl' ).val() + '" method="POST"></form>' );
