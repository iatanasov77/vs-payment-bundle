 ...
 */
final class Version20231207150206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSPAY_PricingPlans ADD gateway_attributes LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSPAY_PricingPlans DROP gateway_attributes');
