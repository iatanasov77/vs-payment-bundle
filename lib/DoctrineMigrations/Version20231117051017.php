 ...
 */
final class Version20231117051017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSPAY_PricingPlans DROP subscription_priority');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSPAY_PricingPlans ADD subscription_priority INT DEFAULT 1 NOT NULL');
