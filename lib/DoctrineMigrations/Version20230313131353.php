 ...
 */
final class Version20230313131353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSPAY_GatewayConfig ADD currency_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_BDE8BA6938248176 ON VSPAY_GatewayConfig (currency_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_BDE8BA6938248176 ON VSPAY_GatewayConfig');
        $this->addSql('ALTER TABLE VSPAY_GatewayConfig DROP currency_id');
