 ...
 */
final class Version20231114023550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSPAY_PricingPlanSubscriptions ADD paid TINYINT(1) DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSPAY_PricingPlanSubscriptions DROP paid');
