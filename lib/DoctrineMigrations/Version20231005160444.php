 ...
 */
final class Version20231005160444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSPAY_PricingPlans ADD recurring_payment TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSPAY_PricingPlans DROP recurring_payment');
