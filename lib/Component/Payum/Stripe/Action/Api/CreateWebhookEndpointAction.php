...
class CreateWebhookEndpointAction implements ActionInterface, GatewayAwareInterface, ApiAwareInterface
{
    use ApiAwareTrait {
        setApi as _setApi;
    }
    ...
    {
        /** @var $request CreateWebhookEndpoint */
        ...
        try {
            ...
            $webhookEndpoint    = WebhookEndpoint::create( $model->toUnsafeArrayWithoutLocal() );
    ...
    {
        return
            $request instanceof CreateWebhookEndpoint &&
