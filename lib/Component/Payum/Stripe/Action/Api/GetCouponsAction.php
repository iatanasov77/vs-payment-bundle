...
class GetCouponsAction implements ActionInterface, GatewayAwareInterface, ApiAwareInterface
{
    use ApiAwareTrait {
        setApi as _setApi;
    }
    ...
    public function execute( $request )
    {
        ...
        try {
            ...
            $coupons    = Coupon::all( $model->toUnsafeArrayWithoutLocal() );
            
            $model->replace( $coupons->toArray( true ) );
