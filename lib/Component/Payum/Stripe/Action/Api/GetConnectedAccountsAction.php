...
class GetConnectedAccountsAction implements ActionInterface, GatewayAwareInterface, ApiAwareInterface
{
    use ApiAwareTrait {
        setApi as _setApi;
    }
    ...
    public function execute( $request )
    {
        ...
        try {
            ...
            $accounts = Account::all( $model->toUnsafeArrayWithoutLocal() );
            
            $model->replace( $accounts->toArray( true ) );
    ...
    {
        return
            $request instanceof GetConnectedAccounts &&
