...
class CreateCouponAction implements ActionInterface, GatewayAwareInterface, ApiAwareInterface
{
    use ApiAwareTrait {
        setApi as _setApi;
    }
    ...
    public function execute( $request )
    {
        ...
        try {
            ...
            $coupon = Coupon::create( $model->toUnsafeArrayWithoutLocal() );
    ...
    {
        return
            $request instanceof CreateCoupon &&
